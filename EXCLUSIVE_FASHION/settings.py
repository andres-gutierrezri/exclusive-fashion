...
from EXCLUSIVE_FASHION.local_settings import IS_DEPLOYED, DATABASE_DICT
from EXCLUSIVE_FASHION.logging_settings import *
from EXCLUSIVE_FASHION.cloud_settings import *
...
HOSTING_DOMAIN = os.getenv("HOSTING_DOMAIN", "exclusive-fashion.up.railway.app")

# Configuración de la URL de alojamiento de la aplicación
HOSTING_URL= os.getenv("HOSTING_URL", "https://exclusive-fashion.up.railway.app")
...
INSTALLED_APPS = [
    ...
    'ecommerce', # Primera Aplicación del Proyecto
]
...
ROOT_URLCONF = 'EXCLUSIVE_FASHION.urls'
...
WSGI_APPLICATION = 'EXCLUSIVE_FASHION.wsgi.application'
